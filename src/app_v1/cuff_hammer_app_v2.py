'''
Name: cuff_hammer_app_v2.py
Last updated: 9/19/24 by Ruth Berkun
                ...
                if ser.in_waiting > 0:
                    ...
                    try:
                        ...
                        if is_valid_data(line):
                            if not saving_data and str(line)[0] == '-':
...
if __name__ == "__main__":
    ...
    port = find_arduino()  # Arduino Giga port
    
    if (read_live_data):
        # Threading to read a serial port
        ...
        print("Thread completed. Proceeding to analyze the CSV file.")
